        ...
        <Slide left>
          <div className="h-100 w-100">
            ...
            <div id="dream-homes-area">
              {/* Content */}
              <div
                id="dream-homes-content"
                className="row w-75 mt-3 dream-homes-content position-absolute"
              >
                <div className="col mt-5 ml-5">
                  <div className="container">
                    <div className="row d-flex flex-column justify-content-start ml-3 mt-2">
                      <div
                        className="we-rebuild-your"
                        style={{ width: "fit-content" }}
                      >
                        We Re-build your
                      </div>
                      <div
                        className="dream-homes"
                        style={{ width: "fit-content" }}
                      >
                        DREAM HOMES
                      </div>
                      <div
                        className="dream-homes-text"
                        style={
                          (this.props.screenSize !== screenSizes.MOBILE) &
                          (this.props.screenSize !== screenSizes.TABLET)
                            ? { maxWidth: "60%" }
                            : {}
                        }
                      >
